...
public class Initialization extends HttpServlet {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -3971632860143467252L;
...
/*		Thread t = new Thread(new Runnable(){
			...
			public void run() {
				...
				ServerSocketListenerThread.ListenerSocket();
			}  
			});  
        t.start(); */ 
